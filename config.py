...
# Configuración de monitoreo - MODO NUCLEAR 🔥
CHECK_INTERVAL_NORMAL = 0.0002  # 5000 checks/segundo (MÁXIMA VELOCIDAD)
CHECK_INTERVAL_TURBO = 0.0002   # 5000 checks/segundo constante
